...
process preprocessing {
    ...
    echo "[${task.tag}] cloning git repo..."
    ${gitCloneFunction}
    ## Note use this fork of the repo to avoid bug if using params. upstream PARAMS assuming motion_params: see README.
    # clone_repo "https://github.com/ucl-biosciences/aind-ephys-preprocessing.git" "${params.versions['PREPROCESSING']}"
